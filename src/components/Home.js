  ...
  return (
    <div className="home">
      ...
      <section className="how-it-works">
        <h2>איך זה עובד</h2>
        <p>רכזי קהילות מייצרים הזמנה עבור ספק מסויים ושולחים לינק לטופס ההזמנה לקהילה שלהם, בטופס חברי הקהילה יכולים לראות הכל על המוצרים ולהזמין. כאשר ערך ההזמנה המינימלי מתמלא, ההזמנה מועברת ליצרן.</p>
      </section>
